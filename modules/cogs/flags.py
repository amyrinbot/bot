...
class FlagParser(commands.Converter):
    ...
    async def _probe_type(
        self, context: commands.Context, name: str, value: Any
    ) -> Any:
        ...
        try:
            ...
            raise InvalidTypeException(
                f'flag "{name}" expected type "{type_}", got "{actual}" instead'
            )
...
DownloadFlags = FlagParser({"format": str, "compress": bool, "include-tags": bool})
